...
import FooterImg from "../../assets/fund-removebg-preview.png";
          ...
          <div className="grid md:grid-cols-4  md:gap-4  py-5 border-t-2 border-gray-300/10 text-black">
            ...
            <div className="py-8 px-4 space-y-4">
              <div className="text-2xl flex items-center gap-2 font-bold uppercase">
                ...
                <p className="">On-Tutor</p>
              </div>
              <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laudantium et fugit, atque eius reprehenderit sapiente!
              </p>
