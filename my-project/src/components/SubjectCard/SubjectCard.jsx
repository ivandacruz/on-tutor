...
import { FaBook, FaLaptop, FaTable } from "react-icons/fa"
                    ...
                    {subjectList.map((subject) => {
                        return (
                            <motion.div
                                ...
                                className="border rounded-lg border-secundary/20 p-4 flex justify-start items-center gap-4 hover:!scale-105 hover:!shadow-xl duration-200 cursor-pointer">
                                <div
                                    style={{ 
                                        color: subject.color,
